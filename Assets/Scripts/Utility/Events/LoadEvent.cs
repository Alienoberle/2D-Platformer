...
{
	public UnityAction<GameScene[], bool, bool> loadEvent;
	public void Raise(GameScene[] locationsToLoad, bool showTransition, bool showLoadingScreen)
	{
		if (loadEvent != null)
			loadEvent.Invoke(locationsToLoad, showTransition, showLoadingScreen);
	}
}
